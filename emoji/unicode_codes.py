...
VOZ_EMOJIS = {
    u':vn_vodich:': NEXT_EMOJI_TAG.format('vn_vodich'),
    u':devil:': NEXT_EMOJI_TAG.format('devil'),
    u':police:': NEXT_EMOJI_TAG.format('police'),
    u':chill:': NEXT_EMOJI_TAG.format('chill'),
    # Tet emojis
...
EMOJI_UNICODE = {
    ...
    u':ban:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/ban.png" id="smilie_246" alt=":ban:" title="Bann">',
