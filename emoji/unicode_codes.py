...
__all__ = ['EMOJI_UNICODE', 'UNICODE_EMOJI', 'VOZ_EMOJIS',
           'EMOJI_ALIAS_UNICODE', 'UNICODE_EMOJI_ALIAS']


NEXT_EMOJI_TAG = '[nextEmoji]{}[/nextEmoji]'
NEXT_STICKER_TAG = '[nextSticker]{}[/nextSticker]'


VOZ_EMOJIS = {
    # Stickers
    u':gach:': NEXT_STICKER_TAG.format('gach'),
    u':sweat:': NEXT_STICKER_TAG.format('sweat'),
    u':go:': NEXT_STICKER_TAG.format('go'),
    u':canny:': NEXT_STICKER_TAG.format('canny'),
    u':sexy:': NEXT_STICKER_TAG.format('sexy'),
    u':look_down:': NEXT_STICKER_TAG.format('look_down'),
    u':adore:': NEXT_STICKER_TAG.format('adore'),
    u':beauty:': NEXT_STICKER_TAG.format('beauty'),
    u':brick:': NEXT_STICKER_TAG.format('brick'),
    u':sosad:': NEXT_STICKER_TAG.format('sosad'),
    u':chaymau:': NEXT_STICKER_TAG.format('chaymau'),
    u':sogood:': NEXT_STICKER_TAG.format('sogood'),
    u':byebye:': NEXT_STICKER_TAG.format('byebye'),
    u':stick:': NEXT_STICKER_TAG.format('stick'),
    u':confident:': NEXT_STICKER_TAG.format('confident'),
    u':ban:': NEXT_STICKER_TAG.format('ban'),
    u':shame:': NEXT_STICKER_TAG.format('shame'),
    u':vn_vodich:': NEXT_STICKER_TAG.format('vn_vodich'),
    u':devil:': NEXT_STICKER_TAG.format('devil'),
    u':police:': NEXT_STICKER_TAG.format('police'),
    u':chill:': NEXT_STICKER_TAG.format('chill'),
    # Tet Emojis
    u":adore_t:": NEXT_EMOJI_TAG.format('adore_t'),
    u":ah_t:": NEXT_EMOJI_TAG.format('ah_t'),
    u":amazed_t:": NEXT_EMOJI_TAG.format('amazed_t'),
    u":angry_t:": NEXT_EMOJI_TAG.format('angry_t'),
    u":b_chung:": NEXT_EMOJI_TAG.format('b_chung'),
    u":b_mai:": NEXT_EMOJI_TAG.format('b_mai'),
    u":b_tet:": NEXT_EMOJI_TAG.format('b_tet'),
    u":badsmell_t:": NEXT_EMOJI_TAG.format('badsmell_t'),
    u":baffle_t:": NEXT_EMOJI_TAG.format('baffle_t'),
    u":beated_t:": NEXT_EMOJI_TAG.format('beated_t'),
    u":beauty_t:": NEXT_EMOJI_TAG.format('beauty_t'),
    u":big_smile_t:": NEXT_EMOJI_TAG.format('big_smile_t'),
    u":boss_t:": NEXT_EMOJI_TAG.format('boss_t'),
    u":canny_t:": NEXT_EMOJI_TAG.format('canny_t'),
    u":choler_t:": NEXT_EMOJI_TAG.format('choler_t'),
    u":chung:": NEXT_EMOJI_TAG.format('chung'),
    u":confident_t:": NEXT_EMOJI_TAG.format('confident_t'),
    u":confuse_t:": NEXT_EMOJI_TAG.format('confuse_t'),
    u":cry_t:": NEXT_EMOJI_TAG.format('cry_t'),
    u":doubt_t:": NEXT_EMOJI_TAG.format('doubt_t'),
    u":dreaming_t:": NEXT_EMOJI_TAG.format('dreaming_t'),
    u":dribble_t:": NEXT_EMOJI_TAG.format('dribble_t'),
    u":embarrassed_t:": NEXT_EMOJI_TAG.format('embarrassed_t'),
    u":go_t:": NEXT_EMOJI_TAG.format('go_t'),
    u":haha_t:": NEXT_EMOJI_TAG.format('haha_t'),
    u":hell_boy_t:": NEXT_EMOJI_TAG.format('hell_boy_t'),
    u":kiss_t:": NEXT_EMOJI_TAG.format('kiss_t'),
    u":look_down_t:": NEXT_EMOJI_TAG.format('look_down_t'),
    u":matrix_t:": NEXT_EMOJI_TAG.format('matrix_t'),
    u":misdoubt_t:": NEXT_EMOJI_TAG.format('misdoubt_t'),
    u":nosebleed_t:": NEXT_EMOJI_TAG.format('nosebleed_t'),
    u":oh_t:": NEXT_EMOJI_TAG.format('oh_t'),
    u":ops_t:": NEXT_EMOJI_TAG.format('ops_t'),
    u":pudency_t:": NEXT_EMOJI_TAG.format('pudency_t'),
    u":sad_t:": NEXT_EMOJI_TAG.format('sad_t'),
    u":sexy_t:": NEXT_EMOJI_TAG.format('sexy_t'),
    u":shame_t:": NEXT_EMOJI_TAG.format('shame_t'),
    u":smile_t:": NEXT_EMOJI_TAG.format('smile_t'),
    u":sogood_t:": NEXT_EMOJI_TAG.format('sogood_t'),
    u":sosad_t:": NEXT_EMOJI_TAG.format('sosad_t'),
    u":stick_t:": NEXT_EMOJI_TAG.format('stick_t'),
    u":sure_t:": NEXT_EMOJI_TAG.format('sure_t'),
    u":surrender_t:": NEXT_EMOJI_TAG.format('surrender_t'),
    u":sweat_t:": NEXT_EMOJI_TAG.format('sweat_t'),
    u":tet:": NEXT_EMOJI_TAG.format('tet'),
    u":tire_t:": NEXT_EMOJI_TAG.format('tire_t'),
    u":waaaht_t:": NEXT_EMOJI_TAG.format('waaaht_t'),
    u":what_t:": NEXT_EMOJI_TAG.format('what_t'),
    u":adore_tg:": NEXT_EMOJI_TAG.format('adore_tg'),
    u":amazed_tg:": NEXT_EMOJI_TAG.format('amazed_tg'),
    u":angry_tg:": NEXT_EMOJI_TAG.format('angry_tg'),
    u":b_chung_g:": NEXT_EMOJI_TAG.format('b_chung_g'),
    u":b_dao:": NEXT_EMOJI_TAG.format('b_dao'),
    u":b_tet_g:": NEXT_EMOJI_TAG.format('b_tet_g'),
    u":baffle_tg:": NEXT_EMOJI_TAG.format('baffle_tg'),
    u":beated_tg:": NEXT_EMOJI_TAG.format('beated_tg'),
    u":beauty_tg:": NEXT_EMOJI_TAG.format('beauty_tg'),
    u":big_smile_tg:": NEXT_EMOJI_TAG.format('big_smile_tg'),
    u":boss_tg:": NEXT_EMOJI_TAG.format('boss_tg'),
    u":canny_tg:": NEXT_EMOJI_TAG.format('canny_tg'),
    u":chaymau_tg:": NEXT_EMOJI_TAG.format('chaymau_tg'),
    u":choler_tg:": NEXT_EMOJI_TAG.format('choler_tg'),
    u":chung_tg:": NEXT_EMOJI_TAG.format('chung_tg'),
    u":confident_tg:": NEXT_EMOJI_TAG.format('confident_tg'),
    u":cry_tg:": NEXT_EMOJI_TAG.format('cry_tg'),
    u":doubt_tg:": NEXT_EMOJI_TAG.format('doubt_tg'),
    u":dreaming_tg:": NEXT_EMOJI_TAG.format('dreaming_tg'),
    u":dribble_tg:": NEXT_EMOJI_TAG.format('dribble_tg'),
    u":embarrassed_tg:": NEXT_EMOJI_TAG.format('embarrassed_tg'),
    u":go_tg:": NEXT_EMOJI_TAG.format('go_tg'),
    u":haha_tg:": NEXT_EMOJI_TAG.format('haha_tg'),
    u":kiss_tg:": NEXT_EMOJI_TAG.format('kiss_tg'),
    u":look_down_tg:": NEXT_EMOJI_TAG.format('look_down_tg'),
    u":matrix_tg:": NEXT_EMOJI_TAG.format('matrix_tg'),
    u":misdoubt_tg:": NEXT_EMOJI_TAG.format('misdoubt_tg'),
    u":nosebleed_tg:": NEXT_EMOJI_TAG.format('nosebleed_tg'),
    u":oh_tg:": NEXT_EMOJI_TAG.format('oh_tg'),
    u":ops_tg:": NEXT_EMOJI_TAG.format('ops_tg'),
    u":pudency_tg:": NEXT_EMOJI_TAG.format('pudency_tg'),
    u":sad_tg:": NEXT_EMOJI_TAG.format('sad_tg'),
    u":sexy_tg:": NEXT_EMOJI_TAG.format('sexy_tg'),
    u":shame_tg:": NEXT_EMOJI_TAG.format('shame_tg'),
    u":smile_tg:": NEXT_EMOJI_TAG.format('smile_tg'),
    u":sogood_tg:": NEXT_EMOJI_TAG.format('sogood_tg'),
    u":sosad_tg:": NEXT_EMOJI_TAG.format('sosad_tg'),
    u":sure_tg:": NEXT_EMOJI_TAG.format('sure_tg'),
    u":surrender_tg:": NEXT_EMOJI_TAG.format('surrender_tg'),
    u":sweat_tg:": NEXT_EMOJI_TAG.format('sweat_tg'),
    u":tet_tg:": NEXT_EMOJI_TAG.format('tet_tg'),
}
...
EMOJI_UNICODE = {
    ...
    u':adore:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/adore.png" id="smilie_208" alt=":adore:" title="Adore">',
    u':beauty:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/beauty.png" id="smilie_224" alt=":beauty:" title="Beauty">',
    u':brick:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/brick.png" id="smilie_232" alt=":brick:" title="Beat Brick">',
    u':sosad:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sosad.png" id="smilie_214" alt=":sosad:" title="Too Sad">',
    u':chaymau:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/chaymau.png" id="smilie_261" alt=":chaymau:" title="Nose Bleedding">',
    u':sogood:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sogood.png" id="smilie_233" alt=":sogood:" title="So Good">',
    u':byebye:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/byebye.png" id="smilie_253" alt=":byebye:" title="Byebye">',
    u':stick:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/stick.png" id="smilie_200" alt=":stick:" title="Burn Joss Stick">',
    u':confident:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/confident.png" id="smilie_222" alt=":confident:" title="Confident">',
    u':ban:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/ban.gnp" id="smilie_246" alt=":ban:" title="Bann">',
    u':shame:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/shame.png" id="smilie_215" alt=":shame:" title="Shame">',
    u':vn_vodich:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/vn_vodich.png" id="smilie_280" alt="Vnvodich" title="Vnvodich">',
    u':devil:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/devil.png" id="smilie_281" alt="Devil" title="Devil">',
    u':police:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/police.png" id="smilie_282" alt="Police" title="Police">',
    u':chill:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/chill.png" id="smilie_283" alt="Chill" title="Chill">',
    # VOZ GIFs
    u':surrender:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/surrender.gif" id="smilie_193" alt=":surrender:" title="Surrender">',
    u':dribble:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/dribble.gif" id="smilie_235" alt=":dribble:" title="Dribble">',
    u':oh:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/oh.gif" id="smilie_229" alt=":oh:" title="Oh">',
    u':aboom:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/after_boom.gif" id="smilie_231" alt=":aboom:" title="After Boom">',
    u':shot:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/beat_shot.gif" id="smilie_216" alt=":shot:" title="Beat Shot">',
    u':rap:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/rap.gif" id="smilie_255" alt=":rap:" title="Rap">',
    u':tire:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/tire.gif" id="smilie_203" alt=":tire:" title="Tire">',
    u':hell_boy:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/hell_boy.gif" id="smilie_199" alt=":hell_boy:" title="Hell Boy">',
    u':lmao:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/lmao.gif" id="smilie_221" alt=":lmao:" title="LMAO">',
    u':flame:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/flame.gif" id="smilie_226" alt=":flame:" title="Flame">',
    u':sure:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sure.gif" id="smilie_241" alt=":sure:" title="Sure">',
    u':fix:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/fix.gif" id="smilie_238" alt=":fix:" title="Fix">',
    u':sad:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sad.gif" id="smilie_227" alt=":sad:" title="Sad">',
    u':what:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/what.gif" id="smilie_240" alt=":what:" title="What">',
    u':choler:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/choler.gif" id="smilie_185" alt=":choler:" title="Choler">',
    u':capture:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/capture.gif" id="smilie_196" alt=":capture:" title="Capture">',
    u':theft:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/theft.gif" id="smilie_257" alt=":theft:" title="Theft">',
    u':ah:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/ah.gif" id="smilie_219" alt=":ah:" title="Ah">',
    u':baffle:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/baffle.gif" id="smilie_239" alt=":baffle:" title="Baffle">',
    u':hehe:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/hehe.gif" id="smilie_244" alt=":hehe:" title="Hehe">',
    u':sos:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sos.gif" id="smilie_243" alt=":sos:" title="SOS">',
    u':angry:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/angry.gif" id="smilie_250" alt=":angry:" title="Angry">',
    u':mage:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/mage.gif" id="smilie_230" alt=":mage:" title="Mage">',
    u':dreaming:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/still_dreaming.gif" id="smilie_205" alt=":dreaming:" title="Still Dreaming">',
    u':bike:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/bike.gif" id="smilie_249" alt=":bike:" title="Bike">',
    u':lovemachine:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/lovemachine.gif" id="smilie_160" alt=":lovemachine:" title="Lovemachine">',
    u':loveyou:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/loveyou.gif" id="smilie_15" alt=":loveyou:" title="Loveyou">',
    u':doublegun:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/doublegun.gif" id="smilie_33" alt=":doublegun:" title="Doublegun">',
    u':please:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/please.gif" id="smilie_209" alt="Please" title="Please">',
    u':lol:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/lol.gif" id="smilie_161" alt=":lol:" title="Lol">',
    u':puke:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/puke.gif" id="smilie_128" alt="Puke" title="Puke">',
    u':no:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/no.gif" id="smilie_49" alt=":no:" title="No">',
    u':Birthday:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/Birthday.gif" id="smilie_165" alt=":Birthday:" title="Birthday">',
    u':winner:': u'<img class="voz_smiley_es" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/winner.gif" id="smilie_92" alt=":winner:" title="Winner">',
    u':nosebleed:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/nosebleed.gif" id="smilie_251" alt=":nosebleed:" title="Nosebleed">',
    u':pudency:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/pudency.gif" id="smilie_201" alt="Pudency" title="Pudency">',
    u':waaaht:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/waaaht.gif" id="smilie_187" alt=":waaaht:" title="Waaaht">',
    u':hungry:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/hungry.gif" id="smilie_194" alt=":hungry:" title="Hungry">',
    u':plaster:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/beat_plaster.gif" id="smilie_247" alt="Plaster" title="Beat Plaster">',
    u':hang:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/hang.gif" id="smilie_223" alt=":hang:" title="Hang">',
    u':ops:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/ops.gif" id="smilie_212" alt=":ops:" title="Ops">',
    u':badsmell:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/bad_smelly.gif" id="smilie_186" alt=":badsmell:" title="Bad Smell">',
    u':kool:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/cool.gif" id="smilie_259" alt=":kool:" title="Cool">',
    u':phone:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/phone.gif" id="smilie_252" alt="Phone" title="Phone">',
    u':bye:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/bye.gif" id="smilie_188" alt=":bye:" title="Bye">',
    u':bang:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/bang.gif" id="smilie_191" alt=":bang:" title="Bang">',
    u':ot:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/ot.gif" id="smilie_225" alt=":ot:" title="OT">',
    u':amazed:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/amazed.gif" id="smilie_195" alt=":amazed:" title="Amazed">',
    u':hug:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/hug.gif" id="smilie_211" alt=":hug:" title="Hug">',
    u':cheers:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/cheers.gif" id="smilie_192" alt=":cheers:" title="Cheers">',
    u':shitty:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/shit.gif" id="smilie_258" alt=":shitty:" title="Shit">',
    u':doubt:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/doubt.gif" id="smilie_256" alt=":doubt:" title="Doubt">',
    u':spam:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/spam.gif" id="smilie_198" alt=":spam:" title="Spam">',
    u':rofl:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/rofl.gif" id="smilie_204" alt=":rofl:" title="ROFL">',
    u':haha:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/haha.gif" id="smilie_189" alt=":haha:" title="Haha">',
    u':smoke:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/smoke.gif" id="smilie_220" alt=":smoke:" title="Smoke">',
    u':matrix:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/matrix.gif" id="smilie_260" alt=":matrix:" title="matrix">',
    u':spiderman:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/spiderman.gif" id="smilie_210" alt=":spiderman:" title="Spiderman">',
    u':misdoubt:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/misdoubt.gif" id="smilie_190" alt=":misdoubt:" title="Misdoubt">',
    u':boss:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/boss.gif" id="smilie_254" alt=":boss:" title="Boss">',
    u':shit:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/shit.gif" id="smilie_163" alt=":shit:" title="Shit">',
    u':runrun:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/runrun.gif" id="smilie_202" alt=":runrun:" title="Runrun">',
    u':stupid:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/stupid.gif" id="smilie_125" alt=":stupid:" title="Stupid">',
    u':boom:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/boom.gif" id="smilie_55" alt=":boom:" title="Boom">',
    u':welcome:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/welcome.gif" id="smilie_237" alt=":welcome:" title="Welcome">',
    u':shoot1:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/shoot1.gif" id="smilie_32" alt=":shoot1:" title="Shoot1">',
    u':yes:': '<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/yes.gif" id="smilie_154" alt=":yes:" title="Yes">',
    u':band:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/band.gif" id="smilie_51" alt=":band:" title="Band">',
    u':mad:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/mad.gif" id="smilie_8" alt=":mad:" title="Mad">',
    u':frown:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/frown.gif" id="smilie_11" alt=":frown:" title="Frown">',
    u':rolleyes:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/rolleyes.gif" id="smilie_7" alt=":rolleyes:" title="Roll Eyes (Sarcastic)">',
    u':eek:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/eek.gif" id="smilie_9" alt=":eek:" title="EEK!">',
    u':D': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/big_smile.gif" id="smilie_213" alt=":D" title="Big Smile">',
    u':)': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/smile.gif" id="smilie_207" alt=":)" title="Smile">',
    u':*': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sweet_kiss.gif" id="smilie_206" alt=":*" title="Sweet Kiss">',
    u':">': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/embarrassed.gif" id="smilie_248" alt=":&quot;>" title="Embarrassed">',
    u':&quot;&gt;': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/embarrassed.gif" id="smilie_248" alt=":&quot;>" title="Embarrassed">',
    u'-_-': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sleep.gif" id="smilie_228" alt="-_-" title="Sleep">',
    u':-s': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/confuse.gif" id="smilie_217" alt=":-s" title="Confuse">',
    u';)': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/wink.gif" id="smilie_4" alt=";)" title="Wink">',
    u':p': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/tongue.gif" id="smilie_5" alt=":p" title="Stick Out Tongue">',
    u':((': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/cry.gif" id="smilie_197" alt=":((" title="Cry">',
    u'^:)^': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/lay.gif" id="smilie_218" alt="^:)^" title="Bow">',
    # VOZ Emojis
    u":adore_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/adore_t.png' id='smilie_adore_t' alt='adore_t' title='adore_t' />",
    u":ah_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/ah_t.png' id='smilie_ah_t' alt='ah_t' title='ah_t' />",
    u":amazed_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/amazed_t.png' id='smilie_amazed_t' alt='amazed_t' title='amazed_t' />",
    u":angry_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/angry_t.png' id='smilie_angry_t' alt='angry_t' title='angry_t' />",
    u":b_chung:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/b_chung.png' id='smilie_b_chung' alt='b_chung' title='b_chung' />",
    u":b_mai:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/b_mai.png' id='smilie_b_mai' alt='b_mai' title='b_mai' />",
    u":b_tet:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/b_tet.png' id='smilie_b_tet' alt='b_tet' title='b_tet' />",
    u":badsmell_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/badsmell_t.png' id='smilie_badsmell_t' alt='badsmell_t' title='badsmell_t' />",
    u":baffle_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/baffle_t.png' id='smilie_baffle_t' alt='baffle_t' title='baffle_t' />",
    u":beated_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/beated_t.png' id='smilie_beated_t' alt='beated_t' title='beated_t' />",
    u":beauty_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/beauty_t.png' id='smilie_beauty_t' alt='beauty_t' title='beauty_t' />",
    u":big_smile_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/big_smile_t.png' id='smilie_big_smile_t' alt='big_smile_t' title='big_smile_t' />",
    u":boss_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/boss_t.png' id='smilie_boss_t' alt='boss_t' title='boss_t' />",
    u":canny_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/canny_t.png' id='smilie_canny_t' alt='canny_t' title='canny_t' />",
    u":choler_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/choler_t.png' id='smilie_choler_t' alt='choler_t' title='choler_t' />",
    u":chung:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/chung.png' id='smilie_chung' alt='chung' title='chung' />",
    u":confident_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/confident_t.png' id='smilie_confident_t' alt='confident_t' title='confident_t' />",
    u":confuse_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/confuse_t.png' id='smilie_confuse_t' alt='confuse_t' title='confuse_t' />",
    u":cry_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/cry_t.png' id='smilie_cry_t' alt='cry_t' title='cry_t' />",
    u":doubt_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/doubt_t.png' id='smilie_doubt_t' alt='doubt_t' title='doubt_t' />",
    u":dreaming_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/dreaming_t.png' id='smilie_dreaming_t' alt='dreaming_t' title='dreaming_t' />",
    u":dribble_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/dribble_t.png' id='smilie_dribble_t' alt='dribble_t' title='dribble_t' />",
    u":embarrassed_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/embarrassed_t.png' id='smilie_embarrassed_t' alt='embarrassed_t' title='embarrassed_t' />",
    u":go_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/go_t.png' id='smilie_go_t' alt='go_t' title='go_t' />",
    u":haha_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/haha_t.png' id='smilie_haha_t' alt='haha_t' title='haha_t' />",
    u":hell_boy_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/hell_boy_t.png' id='smilie_hell_boy_t' alt='hell_boy_t' title='hell_boy_t' />",
    u":kiss_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/kiss_t.png' id='smilie_kiss_t' alt='kiss_t' title='kiss_t' />",
    u":look_down_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/look_down_t.png' id='smilie_look_down_t' alt='look_down_t' title='look_down_t' />",
    u":matrix_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/matrix_t.png' id='smilie_matrix_t' alt='matrix_t' title='matrix_t' />",
    u":misdoubt_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/misdoubt_t.png' id='smilie_misdoubt_t' alt='misdoubt_t' title='misdoubt_t' />",
    u":nosebleed_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/nosebleed_t.png' id='smilie_nosebleed_t' alt='nosebleed_t' title='nosebleed_t' />",
    u":oh_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/oh_t.png' id='smilie_oh_t' alt='oh_t' title='oh_t' />",
    u":ops_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/ops_t.png' id='smilie_ops_t' alt='ops_t' title='ops_t' />",
    u":pudency_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/pudency_t.png' id='smilie_pudency_t' alt='pudency_t' title='pudency_t' />",
    u":sad_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sad_t.png' id='smilie_sad_t' alt='sad_t' title='sad_t' />",
    u":sexy_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sexy_t.png' id='smilie_sexy_t' alt='sexy_t' title='sexy_t' />",
    u":shame_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/shame_t.png' id='smilie_shame_t' alt='shame_t' title='shame_t' />",
    u":smile_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/smile_t.png' id='smilie_smile_t' alt='smile_t' title='smile_t' />",
    u":sogood_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sogood_t.png' id='smilie_sogood_t' alt='sogood_t' title='sogood_t' />",
    u":sosad_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sosad_t.png' id='smilie_sosad_t' alt='sosad_t' title='sosad_t' />",
    u":stick_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/stick_t.png' id='smilie_stick_t' alt='stick_t' title='stick_t' />",
    u":sure_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sure_t.png' id='smilie_sure_t' alt='sure_t' title='sure_t' />",
    u":surrender_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/surrender_t.png' id='smilie_surrender_t' alt='surrender_t' title='surrender_t' />",
    u":sweat_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sweat_t.png' id='smilie_sweat_t' alt='sweat_t' title='sweat_t' />",
    u":tet:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/tet.png' id='smilie_tet' alt='tet' title='tet' />",
    u":tire_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/tire_t.png' id='smilie_tire_t' alt='tire_t' title='tire_t' />",
    u":waaaht_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/waaaht_t.png' id='smilie_waaaht_t' alt='waaaht_t' title='waaaht_t' />",
    u":what_t:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/what_t.png' id='smilie_what_t' alt='what_t' title='what_t' />",
    u":adore_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/adore_tg.png' id='smilie_adore_tg' alt='adore_tg' title='adore_tg' />",
    u":amazed_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/amazed_tg.png' id='smilie_amazed_tg' alt='amazed_tg' title='amazed_tg' />",
    u":angry_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/angry_tg.png' id='smilie_angry_tg' alt='angry_tg' title='angry_tg' />",
    u":b_chung_g:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/b_chung_g.png' id='smilie_b_chung_g' alt='b_chung_g' title='b_chung_g' />",
    u":b_dao:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/b_dao.png' id='smilie_b_dao' alt='b_dao' title='b_dao' />",
    u":b_tet_g:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/b_tet_g.png' id='smilie_b_tet_g' alt='b_tet_g' title='b_tet_g' />",
    u":baffle_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/baffle_tg.png' id='smilie_baffle_tg' alt='baffle_tg' title='baffle_tg' />",
    u":beated_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/beated_tg.png' id='smilie_beated_tg' alt='beated_tg' title='beated_tg' />",
    u":beauty_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/beauty_tg.png' id='smilie_beauty_tg' alt='beauty_tg' title='beauty_tg' />",
    u":big_smile_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/big_smile_tg.png' id='smilie_big_smile_tg' alt='big_smile_tg' title='big_smile_tg' />",
    u":boss_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/boss_tg.png' id='smilie_boss_tg' alt='boss_tg' title='boss_tg' />",
    u":canny_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/canny_tg.png' id='smilie_canny_tg' alt='canny_tg' title='canny_tg' />",
    u":chaymau_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/chaymau_tg.png' id='smilie_chaymau_tg' alt='chaymau_tg' title='chaymau_tg' />",
    u":choler_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/choler_tg.png' id='smilie_choler_tg' alt='choler_tg' title='choler_tg' />",
    u":chung_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/chung_tg.png' id='smilie_chung_tg' alt='chung_tg' title='chung_tg' />",
    u":confident_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/confident_tg.png' id='smilie_confident_tg' alt='confident_tg' title='confident_tg' />",
    u":cry_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/cry_tg.png' id='smilie_cry_tg' alt='cry_tg' title='cry_tg' />",
    u":doubt_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/doubt_tg.png' id='smilie_doubt_tg' alt='doubt_tg' title='doubt_tg' />",
    u":dreaming_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/dreaming_tg.png' id='smilie_dreaming_tg' alt='dreaming_tg' title='dreaming_tg' />",
    u":dribble_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/dribble_tg.png' id='smilie_dribble_tg' alt='dribble_tg' title='dribble_tg' />",
    u":embarrassed_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/embarrassed_tg.png' id='smilie_embarrassed_tg' alt='embarrassed_tg' title='embarrassed_tg' />",
    u":go_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/go_tg.png' id='smilie_go_tg' alt='go_tg' title='go_tg' />",
    u":haha_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/haha_tg.png' id='smilie_haha_tg' alt='haha_tg' title='haha_tg' />",
    u":kiss_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/kiss_tg.png' id='smilie_kiss_tg' alt='kiss_tg' title='kiss_tg' />",
    u":look_down_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/look_down_tg.png' id='smilie_look_down_tg' alt='look_down_tg' title='look_down_tg' />",
    u":matrix_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/matrix_tg.png' id='smilie_matrix_tg' alt='matrix_tg' title='matrix_tg' />",
    u":misdoubt_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/misdoubt_tg.png' id='smilie_misdoubt_tg' alt='misdoubt_tg' title='misdoubt_tg' />",
    u":nosebleed_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/nosebleed_tg.png' id='smilie_nosebleed_tg' alt='nosebleed_tg' title='nosebleed_tg' />",
    u":oh_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/oh_tg.png' id='smilie_oh_tg' alt='oh_tg' title='oh_tg' />",
    u":ops_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/ops_tg.png' id='smilie_ops_tg' alt='ops_tg' title='ops_tg' />",
    u":pudency_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/pudency_tg.png' id='smilie_pudency_tg' alt='pudency_tg' title='pudency_tg' />",
    u":sad_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sad_tg.png' id='smilie_sad_tg' alt='sad_tg' title='sad_tg' />",
    u":sexy_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sexy_tg.png' id='smilie_sexy_tg' alt='sexy_tg' title='sexy_tg' />",
    u":shame_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/shame_tg.png' id='smilie_shame_tg' alt='shame_tg' title='shame_tg' />",
    u":smile_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/smile_tg.png' id='smilie_smile_tg' alt='smile_tg' title='smile_tg' />",
    u":sogood_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sogood_tg.png' id='smilie_sogood_tg' alt='sogood_tg' title='sogood_tg' />",
    u":sosad_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sosad_tg.png' id='smilie_sosad_tg' alt='sosad_tg' title='sosad_tg' />",
    u":sure_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sure_tg.png' id='smilie_sure_tg' alt='sure_tg' title='sure_tg' />",
    u":surrender_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/surrender_tg.png' id='smilie_surrender_tg' alt='surrender_tg' title='surrender_tg' />",
    u":sweat_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sweat_tg.png' id='smilie_sweat_tg' alt='sweat_tg' title='sweat_tg' />",
    u":tet_tg:": u"<img class='voz_smiley' src='https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/tet_tg.png' id='smilie_tet_tg' alt='tet_tg' title='tet_tg' />"
}
...
EMOJI_ALIAS_UNICODE = dict(EMOJI_UNICODE.items(), **{
    ...
    # u':sweat:': u'\U0001F613',
    # u':sweat:': u'<img class="voz_smiley" src="https://s3-ap-southeast-1.amazonaws.com/voz-media/images/smilies/sweat.gif" id="smilie_242" alt=":sweat:" title="Sweat">',
